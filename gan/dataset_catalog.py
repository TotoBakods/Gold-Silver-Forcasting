...
DATASET_CONFIGS = [
    {
        ...
        "deterministic_feature_overrides": {
            ...
            "USA_EPU": "replay_history",
        },
        "score_exclude_cols": ["DFF", "gpr_daily", "USA_EPU"],
        ...
        "seed_env": "GAN_GOLD_VAL_SEEDS",
        "default_seeds": [42, 123],
    },
    {
        "asset": "silver",
        "name": "silver_2015_2026_val",
        "source_file": "df_silver_dataset_APRIL_01_2015_to_APRIL_14_2026.csv",
        "prepared_file": None,
        "preprocess": None,
