...
DATASET_CONFIGS = [
    ...
    {
        "asset": "gold_apr2026",
        "name": "gold_apr2026_train",
        "source_file": "df_gold_dataset_usa_epu_train_2015_2026.csv",
        "prepared_file": None,
        "preprocess": None,
        "target_col": "Gold_Futures",
        "deterministic_feature_overrides": {
        ...
        "seed_env": "GAN_GOLD_APR2026_SEEDS",
        "default_seeds": [0, 1, 2, 3],
    },
    {
        "asset": "silver_apr2026",
        "name": "silver_apr2026_train",
        "source_file": "df_silver_dataset_train_2015_2026.csv",
        "prepared_file": None,
        "preprocess": None,
        "target_col": "Silver_Futures",
        "deterministic_feature_overrides": {},
        ...
        "seed_env": "GAN_SILVER_APR2026_SEEDS",
        "default_seeds": [0, 1, 2, 3],
    },
]
