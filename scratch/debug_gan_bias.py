...
print(f"Mean gold return: {np.mean(gold_returns):.6f}")
print(f"Std gold return: {np.std(gold_returns):.6f}")
print(f"Percentage of positive returns: {np.mean(gold_returns > 0) * 100:.2f}%")
print(f"Max single day return: {np.max(gold_returns):.4f}")
